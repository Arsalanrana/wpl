...
function myFunction() {
	...
	var n = d.getDay();
if(n==1)
    alert("Monday : Available");
else if(n==4)
alert ("Thursday : Available ");
else
...
<ul><div class="abbu">
<a href="doctor.html">Doctors<div class="bo"></div></a>
</div>
</ul>
</div>
</div>
...
if (mysqli_connect_errno()) {
    ...
    exit(); }
$abc="SELECT * FROM `app` where time='Dr. Sami Thursday 08:00-12:00' OR time='Dr. Sami Monday 03:00-06:00'";
...
if (mysqli_connect_errno()) {
    printf("Connect failed: %s\n", mysqli_connect_error());
    exit(); }
$abc="SELECT * FROM `doc` where id=1";
$a123 = $mysqli->query($abc);
if($a123->num_rows>0){
while($row = $a123->fetch_assoc()){
